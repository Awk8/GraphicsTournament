...
public class Referee {
	...
	private String[] timeValues = {"1","3","5","10"}, constraintValues = {"0.0", "1.0", "3.0","5.0", "10.0"};
    ...
    private void buildGUI(){
        ...
        /*constraintBox = new JTextField(4);
        constraintSelectDoc = (PlainDocument) constraintBox.getDocument();
        ...
        playerTwoLight.setForeground(Color.WHITE);
  		...
  		//lineBorder = BorderFactory.createLineBorder(new Color(200, 100, 0));
