	...
	private static void buildMenu(){
		...
		startBtn.addActionListener(new ActionListener(){
			...
			public void actionPerformed(ActionEvent e) {
				...
				ProcessBuilder process = new ProcessBuilder("java", "-jar", "ClientTwo.jar", IP.getText(), port.getText());
				try {
		...
		//springLayout.putConstraint(SpringLayout.WEST, connectBtn, 250, SpringLayout.WEST, mainPanel);
		//springLayout.putConstraint(SpringLayout.NORTH, connectBtn, 350, SpringLayout.NORTH, mainPanel);
